...
export {
  ...
  type AgentTranscriptDisplayDensity,
  type AgentTranscriptDisplayPolicy,
  type AgentTranscriptDisplayPreset,
  type AgentTranscriptDisplayRule,
  type AgentTranscriptDisplayVisibility,
