...
- [x] P004 Docs, skills, examples, and snapshots
  ...
  - Evidence:
    ...
    - Review: Subagent review of `0a52854` found stale pending evidence only; subagent review of `76c13cc` found the same evidence-status issue and no file-scope problems. The phase implementation remains reviewed; subsequent evidence-only notes are not P004 implementation blockers.
    - Commit: `0a52854` Align public docs with compatibility cleanup; `76c13cc` Record P004 review evidence.
    - Push: both commits pushed to `codex-upstream/64bdeed9f7ad`.
  - Tasks:
...
- [x] P005 Release, PR, and CI follow-through
  ...
  - Tasks:
    ...
    - [x] T019 Run final validation matrix.
    ...
    - [x] T020 Rewrite PR #33 scope and final comment.
