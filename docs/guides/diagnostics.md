...
they are not shown as primary chat status. Thread-scoped startup status is also
kept in developer/audit diagnostics until Agent UI has an explicit
thread-scoped visible banner model.
