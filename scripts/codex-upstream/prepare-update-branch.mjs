...
async function writePullRequestBody(report, validation, upstream) {
  ...
  await writeFile(
    ...
    [
      ...
      "- Does not publish packages or edit files inside the `third_party/codex` submodule.",
      "",
      "## Drift Report",
      "",
      report,
      ...
      "- [ ] Confirm the `third_party/codex` submodule pointer matches `CODEX_PROTOCOL_COMMIT`.",
