...
declare function useAgentSkills(cwd?: string): {
    ...
    setSkillEnabled: (params: AgentSkillConfigWriteOptions) => Promise<unknown>;
...
declare function useAgentThread(threadId?: ThreadId): {
    ...
    startThread: (params?: ThreadStartOptions) => Promise<unknown>;
    startThreadWithInput: (input: string | AgentUserInput[], params?: ThreadStartOptions) => Promise<unknown>;
